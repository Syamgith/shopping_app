...
class Products with ChangeNotifier {
  ...
  Future<Void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://flutter-shopapp01.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
      ...
      url =
          'https://flutter-shopapp01.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> deleteProduct(String id) async {
    ...
    if (response.statusCode >= 400) {
      ...
      notifyListeners();
      throw HttpExceptions('Failed to delete product.');
    }
